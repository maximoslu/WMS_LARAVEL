        ...
        <div class="dispatch-builder">
            <section class="surface-card compact-card merchandise-request-catalog wms-flow-card">
                ...
                <section class="wms-action-card">
                    ...
                    <label><input type="checkbox" name="delivery_address_override" value="1" @checked((bool) old('delivery_address_override'))> Usar dirección de entrega alternativa</label>
                    <label class="auth-field">
                        <span>Dirección de entrega alternativa</span>
                        <textarea name="delivery_address_text" maxlength="2000" rows="3" class="auth-input" placeholder="Nombre, dirección, código postal, población y observaciones">{{ old('delivery_address_text') }}</textarea>
                    </label>
                </section>
            </section>
