                    ...
                    @foreach ($elements as $element)
                        @if (is_string($element))
                            <span aria-disabled="true">
                                <span class="inline-flex items-center px-4 py-2 -ml-px text-sm font-medium text-gray-700 bg-white border border-gray-300 cursor-not-allowed leading-5 dark:bg-gray-800 dark:border-gray-600 dark:text-gray-400">{{ $element }}</span>
                            </span>
                        @endif
