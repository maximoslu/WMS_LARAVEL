...
<article class="notification-card notification-card--{{ $appearance['key'] }}{{ $isUnread ? ' is-unread' : '' }}">
    <span class="notification-card-state" aria-hidden="true"></span>

    <div class="notification-card-copy">
        <div class="notification-card-line">
            ...
            <span class="notification-card-badges">
                ...
                @if ($isUnread)
                    <span class="notification-state-badge">Nueva</span>
                @endif
            </span>
        </div>
    ...
    <time class="notification-card-date">{{ $notification->created_at?->format('d/m/Y H:i') }}</time>
