...
<html lang="es">
    <body style="margin:0;padding:24px;background:#edf3f7;font-family:Arial,sans-serif;color:#40515e;">
        <div style="max-width:640px;margin:0 auto;background:#ffffff;border:1px solid #d8e3ea;border-radius:16px;padding:32px;">
            <p style="margin:0 0 12px;color:#0d8b9d;font-size:12px;font-weight:700;letter-spacing:0.12em;text-transform:uppercase;">Prueba de correo</p>
            <h1 style="margin:0 0 16px;color:#13222e;font-size:28px;line-height:1.1;">MAXIMO WMS</h1>
            <p style="margin:0 0 12px;font-size:15px;line-height:1.6;">Este es un correo de prueba enviado mediante Brevo API.</p>
            <p style="margin:0 0 8px;font-size:14px;line-height:1.6;">Fecha: {{ $sentAt }}</p>
            <p style="margin:0 0 20px;font-size:14px;line-height:1.6;">Canal: {{ $mailer }}</p>
